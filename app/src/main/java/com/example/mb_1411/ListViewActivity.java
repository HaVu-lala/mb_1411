    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int position, long l) {
                Toast.makeText(ListViewActivity.this, "Đã xóa " + arrayList.get(position).getName(), Toast.LENGTH_SHORT).show();
        ...
        btnNhap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!name.isEmpty()) {
                    ...
                    Toast.makeText(ListViewActivity.this, "Enter a value", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnCapNhat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (vitri >= 0 && vitri < arrayList.size()) {
                    ...
                    Toast.makeText(ListViewActivity.this, "Please select an item to update", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
